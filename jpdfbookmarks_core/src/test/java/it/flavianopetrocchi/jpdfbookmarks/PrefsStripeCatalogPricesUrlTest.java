/*
 * PrefsStripeCatalogPricesUrlTest.java
 *
...
class PrefsStripeCatalogPricesUrlTest {

    @Test
    void deriveFromCheckPaymentStripsQuery() {
        assertEquals(
                "https://volwkfvgbonuytzdudqo.supabase.co/functions/v1/stripe-catalog-prices",
                Prefs.deriveStripeCatalogPricesUrlFromCheckPayment(
